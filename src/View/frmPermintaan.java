 ...
 * @author Herie-PC
 */
public final class frmPermintaan extends javax.swing.JInternalFrame {
    ...
    private List<EntitasPermintaan> listDaftar;
    EntitasPermintaan e= new EntitasPermintaan();
    ...
    public void tampilkan() {
        ImageIcon imageIcon = new ImageIcon("src/image/reservasi.png"); // load the image to a imageIcon
    ...
    private void tt(){
        tabel();
        dinamisTabel dinamisTabel = new dinamisTabel(tblPermintaan);
        tblPermintaan.revalidate();
    }
    
    private void tabel(){
        tabelHeader=new String[]{"Ruang","Mulai","Selesai","Hari"};
        dtm=new DefaultTableModel (null, tabelHeader);
        tblPermintaan.setModel(dtm);
        tampilTabel();
    }
    
    private void tampilTabel(){
        InterfacePermintaan minta;
        minta=Factory.getMinta();
        listDaftar=minta.selectPermintaan(e);
        dtm=(DefaultTableModel) tblPermintaan.getModel();
        dtm.setRowCount(0);
        try{
            listDaftar.stream().forEach((d) -> {
                //ee=new EntEditData();
                dtm.addRow(new Object[]
                {d.getRuang(),d.getWaktuMulai(),d.getWaktuSelesai(),d.getHari()});
            });
        int ambilBaris=tblPermintaan.getRowCount();
        if(ambilBaris>0) tblPermintaan.addRowSelectionInterval(0, 0);
        }
        catch(Exception ex){
    ...
    private void crudRuang(String proses){
        ...
        switch (proses) {
            case "INSERT":
                minta.insertPermintaan(e);
                break;
            case "UPDATE":
                minta.updatePermintaan(e);
                break;
            case "DELETE":
                minta.deletePermintaan(e);
                break;
            default:
                break;
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("FORM PERMINTAAN");
        ...
        jScrollPane2.setViewportView(tblPermintaan);

        jLabel10.setFont(new java.awt.Font("Trajan Pro", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 0));
        jLabel10.setText("Tabel Permintaan");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtTgl, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
                    .addComponent(txtNik)
    ...
    private void txtNikKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNikKeyTyped
        ...
        txtNik.addKeyListener(new autoNik(txtNik));
        e.setRuang(txtNik.getText());
    ...
    private void tblPermintaanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPermintaanMouseClicked
        // TODO add your handling code here:
        baris=tblPermintaan.getSelectedRow();
        Tanggal t=new Tanggal();
        if(baris>=0){
            txtRuang.setText(dtm.getValueAt(baris, 0).toString());
        }
